...
class TestRAGSystemIntegration:
    ...
    def test_query_retrieves_and_resets_sources(
        ...
        test_sources = [
            SourceLink(text="Test Course - Lesson 0", link="http://example.com/lesson-0")
        ]
...
class TestRAGSystemToolIntegration:
    ...
    @patch('rag_system.VectorStore')
    @patch('rag_system.DocumentProcessor')
    def test_search_tool_registered(self, mock_doc_processor, mock_vector_store_class, test_config):
    ...
    @patch('rag_system.VectorStore')
    @patch('rag_system.DocumentProcessor')
    def test_outline_tool_registered(self, mock_doc_processor, mock_vector_store_class, test_config):
    ...
    @patch('rag_system.VectorStore')
    @patch('rag_system.DocumentProcessor')
    def test_tool_definitions_available(self, mock_doc_processor, mock_vector_store_class, test_config):
